...
class SQLiteHistory(object):
    ...
    def __init_database(self, database=None):
        ...
        if os.path.isfile(database) and os.path.exists(database):
        ...
        self._connection.execute(
            "CREATE TABLE history (id INTEGER PRIMARY KEY, date TEXT, word TEXT, description TEXT)")
    ...
    def reload(self, database=None):
        ...
        return self.__init_database(self.database)
